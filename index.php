...
<div class="container-fluid">
    <div class="row">
        <!--Left-Nav-->
        <div class="mobile-nav collapse" id="mobilenav">
            <div class="menu">
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="#"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></a>
                    </li>
                    <li>
...
<script>
    ...
    $("#filter-button1").click(function(e) {
        e.preventDefault();
       // $("#wrapper").removeClass('toggled');
        $("#wrapper-filter1").toggleClass("toggled");
        if($('#wrapper-filter1').hasClass("toggled")==true){
            $(".table").width("70%").addClass('marginLEFT');
            $(".left-sidebar").width("100%");
        }else {
            $(".table").width("100%").removeClass('marginLEFT');
